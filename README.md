...
**在开始使用本系统前，请务必仔细阅读以下内容：**

### 📝 关于 Prompt 提示词

**Prompt 是决定交易效果的核心因素！**

- ✅ 本项目内置了一个**默认的提示词模板**，可以直接使用
- ⚠️ 但默认模板**并不是完美的**，它只是一个基础示例
- 💡 **强烈建议**您深入学习 Prompt 工程，根据自己的交易理念和风格定制提示词
- 📚 好的 Prompt 应该包含：
  - 明确的交易策略和风控规则
  - 技术指标的解读逻辑
  - 市场环境的判断标准
  - 仓位管理的具体要求
- 🎯 您可以在 Web 界面的 **Prompt 管理** 页面中编辑和测试不同的提示词

**提示词质量直接影响 AI 的决策质量，请务必投入时间研究和优化！**

### ⚡ 关于杠杆风险

**杠杆交易具有极高风险，请务必谨慎！**

- ⚠️ **高杠杆 = 高风险**：杠杆可以放大收益，但也会放大亏损
- 💥 使用过高杠杆可能导致**快速爆仓**，损失全部本金
- 🎓 **建议新手从低杠杆开始**：
  - 首次使用建议 **5倍** 杠杆
  - 使用 **小额资金**（如 20-100 USDT）进行测试
  - 充分测试和优化策略后，再考虑增加杠杆和资金
- 📊 **逐步提升**：
  1. 先用小杠杆 + 小资金运行 1-2 周
  2. 观察 AI 决策质量和盈亏情况
  3. 根据实际表现调整 Prompt 和参数
  4. 确认策略稳定后再逐步增加规模
...
**记住：任何自动化交易系统都无法替代您自己的判断和风控意识！**

---

## 🚀 快速开始

### 方式一：Windows 一键安装程序（推荐）

**适合不熟悉命令行的用户，下载即用！**

1. 访问 [GitHub Releases](https://github.com/xiazhi88/DesicAi/releases)
2. 下载最新版本的 `DesicAiInstaller.exe`
3. 双击运行安装程序，按提示完成安装
4. 安装完成后自动启动 Web 管理界面
5. 在浏览器中访问 `http://localhost:1235` 开始配置
